          ...
          <>
            ...
            <section>
              <div className="flex items-baseline gap-2">
                ...
                {/*
                  時間割へ戻る。既定の表示はあちらなので、
                  「ひらく」ではなく表示の切り替えとして見せる
                  （時間割側の「リスト」ボタンと対になる）
                */}
                <Link
                  href="/plan"
                  className="ml-auto flex min-h-11 shrink-0 items-center gap-1.5 rounded-full border border-line bg-surface px-3.5 text-[12.5px] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
                >
                  <svg
                    width="12"
                    height="12"
                  ...
                  >
                    ...
                    <path d="M2 6.5h12M5.5 1.5v2.5M10.5 1.5v2.5" />
                  </svg>
                  時間割
                </Link>
              </div>
